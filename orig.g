...
//	')'
	...
	'('
		...
		| (  anyUriBag ',' anyUriBag )
		| (  x500NameBag ',' x500NameBag )
		| (  rfc822NameBag ',' rfc822NameBag )
		| (  hexBinaryBag ',' hexBinaryBag )
		| (  base64Bag ',' base64Bag )
	')'
	| REGEXMATCH_TOK '(' stringExpr ',' anyExpr ')'
	| ( NODEEQUAL_TOK | NODEMATCH_TOK ) '(' stringExpr ',' stringExpr ')'
	;
