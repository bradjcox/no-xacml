...
//	| BAG_TOK '(' anyUriExpr ( ',' anyUriExpr)+ ')'
	;
base64BinaryBag
	: ((BASE64BINARY_TOK) => BASE64BINARY_TOK STRING_LIST)
...
//	| UNION_TOK '(' base64BinaryBag ',' base64BinaryBag ')'
	;
booleanBag
	: (BOOLEAN_TOK) => BOOLEAN_TOK STRING_LIST
